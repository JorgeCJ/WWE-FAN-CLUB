  ...
  return (
    <Suspense fallback={<Loading />}>
      {isLoading ? (
        ...
        <div className="flex flex-wrap w-screen min-h-screen bg-custom-bg bg-cover bg-center border-solid border-2 border-slate-50 relative">
          <Header />
          <h1 className="flex flex-wrap text-slate-100 text-5xl items-center justify-center w-screen border-solid border-2 border-white bg-black">Who is the best male fighter?</h1>
